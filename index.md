...
* Working directory: /home
* Error: none
* By giving the command "cd" followed by the path to a working directory in the "messages" folder, the working directory is now set to <mark>/home/lecture1/messages<mark/> instead of <mark>/home<mark/>. 
